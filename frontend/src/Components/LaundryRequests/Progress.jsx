...
const Progress = () => {
    ...
    if (laundries) {
        ProgressArray = laundries.filter(e => {
                ...
                <>
                    ...
                    <div className='status_container'>
                        <div className="overview_request_container">
                            <p> <b>Dashboard / Overview / Stauts / Progress</b></p>

                        </div>
                        {ProgressArray.length === 0 ? <h1> No Request Found </h1> : <>
...

                                        {
                                            ...
                                            ProgressArray.map(e => {
                                                ...
                                                return <tr key={e._id}>
                                                    ...
                                                    <td style={{ color: "blue", font: "bold" }}><strong>{e.status}</strong> </td>
