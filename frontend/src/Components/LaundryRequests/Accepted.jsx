...
const Accepted = () => {
    ...
    var AcceptedArray = [];
    if (laundries) {
        AcceptedArray = laundries.filter(e => {
    ...
    }, [laundries, loading, error, iscreated, dispatch, navigate, alert,window.innerWidth])
                ...
                <>
                    ...
                    <div className='status_container'>
                        <div className="overview_request_container">
                            <p> <b>Dashboard / Overview / Status / Accepted</b></p>

                        </div>
                        {AcceptedArray.length === 0 ? <h1> No Request Found </h1> : <>
...

                                        {
                                            ...
                                            AcceptedArray.map(e => {
                                                ...
                                                return <tr key={e._id}>
                                                    ...
                                                    <td style={{ color: "red", font: "bold" }}><strong>{e.status}</strong> </td>
